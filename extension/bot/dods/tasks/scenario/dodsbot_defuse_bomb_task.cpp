...
TaskEventResponseResult<CDoDSBot> CDoDSBotDefuseBombTask::OnBombPlanted(CDoDSBot* bot, const Vector& position, const int teamIndex, CBaseEntity* player, CBaseEntity* ent)
{
	return TryToMaintain(PRIORITY_CRITICAL);
}
